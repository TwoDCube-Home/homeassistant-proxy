...
func main() {
	...
	proxy.Director = func(req *http.Request) {
		logger.Info("Forwarding request", zap.String("url", req.URL.String()), zap.String("remote_addr", req.RemoteAddr), zap.String("x_forwarded_for", req.Header.Get("X-Forwarded-For")))
		director(req)
	}
	http.Handle("/", proxy)
